...
this, Build -> Clean Project. You can run the app either on an emulator or on your phone if it uses 
min Android 5.0(Lollipop) and max Android 8.1.0(Oreo). Press Run(Shift + F10) and select your preffered
platform.
